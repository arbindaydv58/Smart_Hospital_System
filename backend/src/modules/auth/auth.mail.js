...
`;
  ...
  notifyUserActivationSuccess = async (user) => {
    try {
      const loginLink = `${AppConfig.feURL}/login`;

      const emailTemplate = `
<div style="margin:0;padding:0;background-color:#f8fafc;">
  <table width="100%" style="background:linear-gradient(180deg,#ecfeff 0%,#f8fafc 100%);padding:30px 0;">
    <tr>
      <td align="center">
        <table width="680" style="background:#ffffff;border-radius:16px;border:1px solid #bae6fd;font-family:Arial,sans-serif;color:#0f172a;box-shadow:0 10px 30px rgba(0,0,0,0.08);">

          <tr>
            <td style="padding:30px 40px;background:linear-gradient(135deg,#059669,#0f766e);color:#ffffff;">
              <div style="font-size:12px;font-weight:700;letter-spacing:1px;text-transform:uppercase;">
                Smart Hospital System
              </div>
              <h1 style="margin:12px 0 6px;font-size:28px;">
              ...
              <p style="margin:0;font-size:15px;color:#ccfbf1;">
                Your profile is now active and ready to use.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:30px 40px;">
              ...
              <p style="font-size:15px;line-height:25px;color:#334155;">
                Great news, your Smart Hospital System account has been activated successfully.
                You can now log in and access all available services.
              </p>

              <p style="font-size:15px;line-height:25px;color:#334155;">
                Use your account to manage appointments, access health records, and stay updated with important notifications.
              </p>

              <a href="${loginLink}" 
                 style="display:inline-block;padding:14px 28px;background:#0f766e;color:#fff;
